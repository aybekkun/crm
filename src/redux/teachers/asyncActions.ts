...
import { ITeachers, ITeachersForm, oneTeacherParamsProps } from "./types";
import { ITeacherOneData } from "./types";
...
export const createTeacher = createAsyncThunk(
  ...
  async ({ name, surname, phone, birthday, address, course_ids, password, percent }: ITeachersForm, thunkAPI) => {
    try {
...
export const updateTeacher = createAsyncThunk(
  ...
  async ({ id, name, surname, phone, birthday, address, course_ids, password, percent }: ITeachersForm, thunkAPI) => {
    try {
...
export const deleteTeacher = createAsyncThunk("teacher/deleteTeacher", async (id: number, thunkAPI) => {
  try {
