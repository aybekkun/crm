...
import { FetchExpensesProps, IExpenseData, IExpenses } from "./types";
...
export const deleteExpense = createAsyncThunk("expenses/deleteExpense", async (id: number, thunkAPI) => {
  try {
