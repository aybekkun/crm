...
import { fetchGroups, fetchOneGroup } from "./asyncActions";
import { IGroups, IGroupsForm, IGroupsState, IOneGroupData } from "./types";
...
export const { setPageGroups, setFormGroups, setResetFormGroups, setCurrentMonth } = groupsSlice.actions;
